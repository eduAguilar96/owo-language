...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/Users/a4ron/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/Users/a4ron/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/Users/a4ron/Desktop/tecCar/tecSem8/compiladores/compilador/owo-language/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/OwoIDE/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/Users/a4ron/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/Users/a4ron/Desktop/tecCar/tecSem8/compiladores/compilador/owo-language/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/OwoIDE/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Users/a4ron/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/darwin-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  minor => "1.1",
