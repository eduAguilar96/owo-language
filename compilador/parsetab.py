...
_lr_productions = [
  ...
  ('empty -> <empty>','empty',0,'p_empty','lang.py',113),
  ('program -> program_aux codeblock','program',2,'p_program','lang.py',119),
  ('program_aux -> IDK','program_aux',1,'p_program_aux','lang.py',125),
  ('program_aux -> OWO','program_aux',1,'p_program_aux','lang.py',126),
  ('n_seen_type -> <empty>','n_seen_type',0,'p_n_seen_type','lang.py',131),
  ('type -> INT_TYPE n_seen_type','type',2,'p_type','lang.py',138),
  ('type -> STRING_TYPE n_seen_type','type',2,'p_type','lang.py',139),
  ('type -> DOUBLE_TYPE n_seen_type','type',2,'p_type','lang.py',140),
  ('type -> FLOAT_TYPE n_seen_type','type',2,'p_type','lang.py',141),
  ('type -> BOOL_TYPE n_seen_type','type',2,'p_type','lang.py',142),
  ('logic_operator -> GREATERTHAN','logic_operator',1,'p_logic_operator','lang.py',148),
  ('logic_operator -> LESSTHAN','logic_operator',1,'p_logic_operator','lang.py',149),
  ('logic_operator -> EQUALEQUAL','logic_operator',1,'p_logic_operator','lang.py',150),
  ('logic_operator -> LESSTHANOREQUAL','logic_operator',1,'p_logic_operator','lang.py',151),
  ('logic_operator -> GREATERTHANOREQUAL','logic_operator',1,'p_logic_operator','lang.py',152),
  ('logic_operator -> NOTEQUAL','logic_operator',1,'p_logic_operator','lang.py',153),
  ('arithmetic_operator -> PLUS','arithmetic_operator',1,'p_arithmetic_operator','lang.py',170),
  ('arithmetic_operator -> MINUS','arithmetic_operator',1,'p_arithmetic_operator','lang.py',171),
  ('arithmetic_operator -> TIMES','arithmetic_operator',1,'p_arithmetic_operator','lang.py',172),
  ('arithmetic_operator -> DIVIDE','arithmetic_operator',1,'p_arithmetic_operator','lang.py',173),
  ('arithmetic_operator -> MODULUS','arithmetic_operator',1,'p_arithmetic_operator','lang.py',174),
  ('literal -> FLOAT','literal',1,'p_literal','lang.py',180),
  ('literal -> INT','literal',1,'p_literal','lang.py',181),
  ('literal -> STRING','literal',1,'p_literal','lang.py',182),
  ('function_type -> type','function_type',1,'p_function_type','lang.py',188),
  ('function_type -> VOID','function_type',1,'p_function_type','lang.py',189),
  ('function_definition -> FUNCTION NAME parameter_list DOUBLEDOT function_type LCURLY codeblock RCURLY','function_definition',8,'p_function_definition','lang.py',195),
  ('function_call -> NAME LPARENTHESIS parameter_list RPARENTHESIS','function_call',4,'p_function_call','lang.py',201),
  ('parameter_list -> empty','parameter_list',1,'p_parameter_list','lang.py',207),
  ('parameter_list -> parameter','parameter_list',1,'p_parameter_list','lang.py',208),
  ('parameter_list -> parameter COMMA parameter_list','parameter_list',3,'p_parameter_list','lang.py',209),
  ('parameter -> type NAME','parameter',2,'p_parameter','lang.py',215),
  ('parameter -> assign','parameter',1,'p_parameter','lang.py',216),
  ('expression -> exp','expression',1,'p_expression','lang.py',222),
  ('expression -> exp logic_operator exp','expression',3,'p_expression','lang.py',223),
  ('exp -> termino','exp',1,'p_exp','lang.py',229),
  ('exp -> termino PLUS exp','exp',3,'p_exp','lang.py',230),
  ('exp -> termino MINUS exp','exp',3,'p_exp','lang.py',231),
  ('termino -> factor','termino',1,'p_termino','lang.py',237),
  ('termino -> factor TIMES termino','termino',3,'p_termino','lang.py',238),
  ('termino -> factor DIVIDE termino','termino',3,'p_termino','lang.py',239),
  ('factor -> LPARENTHESIS expression RPARENTHESIS','factor',3,'p_factor','lang.py',245),
  ('factor -> PLUS value','factor',2,'p_factor','lang.py',246),
  ('factor -> MINUS value','factor',2,'p_factor','lang.py',247),
  ('factor -> value','factor',1,'p_factor','lang.py',248),
  ...
  ('statement -> statement_aux SEMICOLON','statement',2,'p_statement','lang.py',304),
  ('statement_aux -> assign','statement_aux',1,'p_statement_aux','lang.py',310),
  ('statement_aux -> function_call','statement_aux',1,'p_statement_aux','lang.py',311),
  ('codeblock -> empty','codeblock',1,'p_codeblock','lang.py',318),
  ('codeblock -> codeblock_aux codeblock','codeblock',2,'p_codeblock','lang.py',319),
  ('codeblock_aux -> statement','codeblock_aux',1,'p_codeblock_aux','lang.py',325),
  ('codeblock_aux -> function_definition','codeblock_aux',1,'p_codeblock_aux','lang.py',326),
  ('codeblock_aux -> condition_if','codeblock_aux',1,'p_codeblock_aux','lang.py',327),
  ('codeblock_aux -> loop','codeblock_aux',1,'p_codeblock_aux','lang.py',328),
  ('loop -> forloop','loop',1,'p_loop','lang.py',334),
  ('loop -> whileloop','loop',1,'p_loop','lang.py',335),
  ('whileloop -> WHILE LPARENTHESIS expression RPARENTHESIS LCURLY codeblock RCURLY','whileloop',7,'p_whileloop','lang.py',341),
  ('forloop -> FOR LPARENTHESIS assign DOUBLEDOT expression DOUBLEDOT assign RPARENTHESIS LCURLY codeblock RCURLY','forloop',11,'p_forloop','lang.py',347),
  ('condition_if -> IF LPARENTHESIS expression RPARENTHESIS LCURLY codeblock RCURLY condition_else','condition_if',8,'p_condition_if','lang.py',353),
  ('condition_else -> ELSE LCURLY codeblock RCURLY','condition_else',4,'p_condition_else','lang.py',359),
  ('condition_else -> empty','condition_else',1,'p_condition_else','lang.py',360),
]
